...
namespace UnityGameFramework.Editor
{
    ...
    internal static class BuildSettings
    {
        ...
        {
            string path = Path.Combine(Application.dataPath, "GameFramework/Configs/BuildSettings.xml");
            s_ConfigurationPath = Type.GetConfigurationPath<BuildSettingsConfigPathAttribute>() ?? path.Replace('\\', '/');
