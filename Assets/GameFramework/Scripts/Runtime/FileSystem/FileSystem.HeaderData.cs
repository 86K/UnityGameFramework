...
namespace UnityGameFramework.Runtime
{
    internal sealed partial class FileSystem : IFileSystem
    {
        ...
        private struct HeaderData
        {
            ...
            public bool IsValid =>
                m_Header.Length == HeaderLength && m_Header[0] == Header[0] && m_Header[1] == Header[1] && m_Header[2] == Header[2] && m_Version == FileSystemVersion && m_EncryptBytes.Length == EncryptBytesLength
